	...
	if int32(1) <= l2 {
		...
		if l2 != v14 {
			...
			for {
				v33 = l0 + v26
				v34 = int32(1)
				v36 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v33+v34))))
				v37 = l1 + v26
				v40 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v37+v34))))
				v41 = v36 - v40
				v43 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v33))))
				v44 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v37))))
				v45 = v43 - v44
				v48 = v41*v41 + (v45*v45 + v28)
				v50 = v26 + int32(2)
				if l2&int32(2147483646) != v50 {
					v26 = v50
					v28 = v48
					continue
				} else {
		...
		if l2&v14 == int32(0) {
			...
			v64 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v54))))
			v66 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1+v54))))
			v67 = v64 - v66
			v71 = v67*v67 + v56
		}
		return v71
	...
	if l2 < int32(1) {
		...
		if base.Ui32(l2) < base.Ui32(int32(4)) {
			...
			for {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v30))) = v31 + v33
				v36 = int32(4)
				v37 = v30 + v36
				v38 = *(*int32)(unsafe.Add(mBase, uint32(v37)))
				v41 = *(*int32)(unsafe.Add(mBase, uint32(v32+v36)))
				*(*int32)(unsafe.Add(mBase, uint32(v37))) = v38 + v41
				v44 = int32(8)
				v45 = v30 + v44
				v46 = *(*int32)(unsafe.Add(mBase, uint32(v45)))
				v49 = *(*int32)(unsafe.Add(mBase, uint32(v32+v44)))
				*(*int32)(unsafe.Add(mBase, uint32(v45))) = v46 + v49
				v52 = int32(12)
				v53 = v30 + v52
				v54 = *(*int32)(unsafe.Add(mBase, uint32(v53)))
				v57 = *(*int32)(unsafe.Add(mBase, uint32(v32+v52)))
				*(*int32)(unsafe.Add(mBase, uint32(v53))) = v54 + v57
				v63 = v25 + v36
				if l2&int32(2147483644) != v63 {
					v25 = v63
					v27 = v27 + int32(16)
					continue
				} else {
		...
		if v13 == int32(0) {
			...
			for {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v82))) = v89 + v90
				v93 = int32(4)
				v98 = v83 + int32(-1)
				if v98 != 0 {
					v82 = v82 + v93
	...
	if l3 < int32(1) {
		...
		if l3 == v12 {
			...
			for {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v23))) = v29 + v30
				v33 = int32(4)
				v37 = *(*int32)(unsafe.Add(mBase, uint32(v27+v33)))
				v40 = *(*int32)(unsafe.Add(mBase, uint32(v28+v33)))
				*(*int32)(unsafe.Add(mBase, uint32(v23+v33))) = v37 + v40
				v43 = int32(8)
				v50 = v25 + int32(2)
				if l3&int32(2147483646) != v50 {
					v23 = v23 + v43
					v25 = v50
					v27 = v27 + v43
					v28 = v28 + v43
		...
		if l3&v12 == int32(0) {
			...
			v67 = *(*int32)(unsafe.Add(mBase, uint32(l1+v64)))
			v69 = *(*int32)(unsafe.Add(mBase, uint32(l0+v64)))
			*(*int32)(unsafe.Add(mBase, uint32(l2+v64))) = v67 + v69
		}
	}
	return
}
	...
	if l1 < int32(1) {
		...
		if base.Ui32(l1) < base.Ui32(int32(4)) {
			...
			for {
				...
				if base.Ui32(int32(16777215)) < base.Ui32(v25) {
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v19))) = l2
				}
				v30 = v19 + int32(4)
				v31 = *(*int32)(unsafe.Add(mBase, uint32(v30)))
				if base.Ui32(int32(16777215)) < base.Ui32(v31) {
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v30))) = l2
				}
				v36 = v19 + int32(8)
				v37 = *(*int32)(unsafe.Add(mBase, uint32(v36)))
				if base.Ui32(int32(16777215)) < base.Ui32(v37) {
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v36))) = l2
				}
				v42 = v19 + int32(12)
				v43 = *(*int32)(unsafe.Add(mBase, uint32(v42)))
				if base.Ui32(int32(16777215)) < base.Ui32(v43) {
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v42))) = l2
				}
				v50 = v22 + int32(4)
				if l1&int32(2147483644) != v50 {
					v19 = v19 + int32(16)
					v22 = v50
					continue
				} else {
		...
		if v11 == int32(0) {
			...
			v65 = l0 + v56<<(uint(int32(2))%32)
			v67 = v11
			for {
				v71 = *(*int32)(unsafe.Add(mBase, uint32(v65)))
				if base.Ui32(int32(16777215)) < base.Ui32(v71) {
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v65))) = l2
				}
				v78 = v67 + int32(-1)
				if v78 != 0 {
					v65 = v65 + int32(4)
		...
		if l2 < int32(1) {
			...
			for {
				...
				for {
					...
					v35 = int32(15)
					v36 = v34 & v35
					v38 = v36 * int32(_a_F_ApplyAlphaMultiply_16b_C_0)
					v39 = int32(240)
					v41 = int32(4)
					v45 = int32(16)
					v49 = int32(base.Ui32(v38*(v34&v39|int32(base.Ui32(v34)>>(uint(v41)%32))))>>(uint(v45)%32))&v39 | v36
					*(*uint8)(unsafe.Add(mBase, uint32(v33))) = uint8(v49)
					v51 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v27))))
					v72 = int32(base.Ui32(v38*(v51&v39|int32(base.Ui32(v51)>>(uint(v41)%32))))>>(uint(v45)%32))&v39 | int32(base.Ui32(v38*((v51&v35|v51<<(uint(v41)%32))&int32(255)))>>(uint(int32(20))%32))
					*(*uint8)(unsafe.Add(mBase, uint32(v27))) = uint8(v72)
					v77 = v28 + int32(-1)
					if v77 != 0 {
						v27 = v27 + int32(2)
						v28 = v77
