	...
	*(*uint8)(unsafe.Add(mBase, uint32(l4))) = uint8(v18)
	if l1 < int32(2) {
		if l2 < int32(2) {
			...
			v212 = int32(3)
			v213 = v211 & v212
			if base.Ui32(l2+int32(-2)) < base.Ui32(v212) {
				v277 = l0
				v281 = l4
				v282 = v18
			} else {
				v223 = l3 << (uint(int32(1)) % 32)
				v226 = l3 * int32(3)
				v229 = l3 << (uint(int32(2)) % 32)
				v236 = int32(0)
				v240 = v18
				v245 = v211 & int32(-4)
				for {
					v254 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+l3+v236))))
					v255 = v254 - v240
					*(*uint8)(unsafe.Add(mBase, uint32(l4+l3+v236))) = uint8(v255)
					v259 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v223+v236))))
					v260 = v259 - v254
					*(*uint8)(unsafe.Add(mBase, uint32(l4+v223+v236))) = uint8(v260)
					v264 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v226+v236))))
					v265 = v264 - v259
					*(*uint8)(unsafe.Add(mBase, uint32(l4+v226+v236))) = uint8(v265)
					v269 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v229+v236))))
					v270 = v269 - v264
					*(*uint8)(unsafe.Add(mBase, uint32(l4+v229+v236))) = uint8(v270)
					v272 = v236 + v229
					v274 = v245 + int32(-4)
					if v274 != 0 {
						v236 = v272
			...
			if v213 == int32(0) {
				...
				v307 = v213
				for {
					v315 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v277+v297))))
					v316 = v315 - v301
					*(*uint8)(unsafe.Add(mBase, uint32(v281+v297))) = uint8(v316)
					v320 = v307 + int32(-1)
					if v320 != 0 {
						v297 = v297 + l3
						v301 = v315
		...
		if v23&int32(1) == int32(0) {
			...
			v88 = int32(1)
			v94 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v88+v70))))
			v96 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+v70))))
			v97 = v94 - v96
			*(*uint8)(unsafe.Add(mBase, uint32(l4+v88+v70))) = uint8(v97)
		}
		if l2 < int32(2) {
		} else {
			v101 = int32(1)
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v125))) = uint8(v128)
				...
				if v27 == v130 {
					...
					for {
						...
						v152 = int32(1)
						v154 = v108 + v135
						v157 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v154+v152))))
						v158 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v154))))
						v159 = v157 - v158
						*(*uint8)(unsafe.Add(mBase, uint32(v151+v152))) = uint8(v159)
						v161 = int32(2)
						v165 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v154+v161))))
						v166 = v165 - v157
						*(*uint8)(unsafe.Add(mBase, uint32(v151+v161))) = uint8(v166)
						v171 = v145 + int32(-2)
						if int32(0)-v23&int32(-2) != v171 {
							v135 = v135 + v161
							v145 = v171
							continue
						} else {
				...
				if v23&v101 == int32(0) {
					...
					v194 = int32(1)
					v200 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v126+v194+v176))))
					v202 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v126+v176))))
					v203 = v200 - v202
					*(*uint8)(unsafe.Add(mBase, uint32(v125+v194+v176))) = uint8(v203)
				}
				v206 = v122 + int32(1)
				if v206 != l2 {
					v108 = v126
