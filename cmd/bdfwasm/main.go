...
// converters (Word, PowerPoint, Excel, CSV, Visio, metafiles) or the PDF
// one, for smaller modules. bdf_noconv leaves out the image and WOFF2 encoders:
// a document drawn where it is converted gains nothing from them.
//
