...
func F_VP8IteratorSaveBoundary(m *base.Module, l0 int32) {
	...
	if v127+int32(-1) <= v6 {
		...
		v132 = *(*int64)(unsafe.Add(mBase, uint32(v5)+480))
		*(*int64)(unsafe.Add(mBase, uint32(v131))) = v132
		v134 = int32(8)
		v138 = *(*int64)(unsafe.Add(mBase, uint32(v5+int32(488))))
		*(*int64)(unsafe.Add(mBase, uint32(v131+v134))) = v138
		v140 = *(*int32)(unsafe.Add(mBase, uint32(l0)+324))
		v141 = *(*int64)(unsafe.Add(mBase, uint32(v5)+240))
		*(*int64)(unsafe.Add(mBase, uint32(v140))) = v141
		v147 = *(*int64)(unsafe.Add(mBase, uint32(v5+int32(248))))
		*(*int64)(unsafe.Add(mBase, uint32(v140+v134))) = v147
	}
	return
}
