...
// Excel, CSV, Visio, draw.io, DXF, metafiles) or the HTML and Markdown
...
//	  name?: string,     // the file name, whose extension tells what the content does not (a CSV file of one line)
