...
func F_MaxDiffsForRow(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if l0 < int32(3) {
		...
		if l4 == int32(0) {
			...
			v31 = int32(16)
			v36 = int32(-16711936)
			v40 = int32(base.Ui32(v21) >> (uint(v24) % 32))
			v54 = (v25&v26+v20&v28+v25<<(uint(v31)%32))&v28 | v20&v36
			v55 = (v40&v26+v21&v28+v40<<(uint(v31)%32))&v28 | v21&v36
		}
		v65 = l1 << (uint(int32(2)) % 32)
		__phi69 = l2 + int32(4)
		__phi72 = v54
		__phi73 = v55
		__phi75 = l3 + int32(1)
		...
		for {
			...
			v88 = *(*int32)(unsafe.Add(mBase, uint32(v69+v65)))
			v90 = *(*int32)(unsafe.Add(mBase, uint32(v69+(int32(0)-v65))))
			if l4 == int32(0) {
				v138 = v88
				v140 = v90
				v141 = v86
				...
				v93 = int32(8)
				v94 = int32(base.Ui32(v86) >> (uint(v93) % 32))
				v95 = int32(255)
				v97 = int32(16711935)
				v100 = int32(16)
				v105 = int32(-16711936)
				v109 = int32(base.Ui32(v88) >> (uint(v93) % 32))
				v124 = int32(base.Ui32(v90) >> (uint(v93) % 32))
				v138 = (v109&v95+v88&v97+v109<<(uint(v100)%32))&v97 | v88&v105
				v140 = (v124&v95+v90&v97+v124<<(uint(v100)%32))&v97 | v90&v105
				v141 = (v94&v95+v86&v97+v94<<(uint(v100)%32))&v97 | v86&v105
			}
			v142 = int32(24)
			v143 = int32(base.Ui32(v72) >> (uint(v142) % 32))
			v146 = v143 - int32(base.Ui32(v140)>>(uint(v142)%32))
			v147 = int32(31)
			v148 = v146 >> (uint(v147) % 32)
			v150 = v146 ^ v148 - v148
			v151 = int32(16)
			v153 = int32(255)
			v154 = int32(base.Ui32(v72)>>(uint(v151)%32)) & v153
			v159 = v154 - int32(base.Ui32(v140)>>(uint(v151)%32))&v153
			v161 = v159 >> (uint(v147) % 32)
			v163 = v159 ^ v161 - v161
			...
			v166 = int32(8)
			v168 = int32(255)
			v169 = int32(base.Ui32(v72)>>(uint(v166)%32)) & v168
			v174 = v169 - int32(base.Ui32(v140)>>(uint(v166)%32))&v168
			v175 = int32(31)
			v176 = v174 >> (uint(v175) % 32)
			v178 = v174 ^ v176 - v176
			v180 = v72 & v168
			v183 = v180 - v140&v168
			v185 = v183 >> (uint(v175) % 32)
			v187 = v183 ^ v185 - v185
			if base.Ui32(v187) < base.Ui32(v178) {
				v189 = v178
			} else {
				v189 = v187
			}
			if base.Ui32(v189) < base.Ui32(v165) {
				v191 = v165
			} else {
				v191 = v189
			}
			v194 = v143 - int32(base.Ui32(v138)>>(uint(int32(24))%32))
			v195 = int32(31)
			v196 = v194 >> (uint(v195) % 32)
			v198 = v194 ^ v196 - v196
			v203 = v154 - int32(base.Ui32(v138)>>(uint(int32(16))%32))&int32(255)
			v205 = v203 >> (uint(v195) % 32)
			v207 = v203 ^ v205 - v205
			if base.Ui32(v207) < base.Ui32(v198) {
				v209 = v198
			} else {
				v209 = v207
			}
			v212 = int32(255)
			v214 = v169 - int32(base.Ui32(v138)>>(uint(int32(8))%32))&v212
			v215 = int32(31)
			v216 = v214 >> (uint(v215) % 32)
			v218 = v214 ^ v216 - v216
			v221 = v180 - v138&v212
			v223 = v221 >> (uint(v215) % 32)
			v225 = v221 ^ v223 - v223
			if base.Ui32(v225) < base.Ui32(v218) {
				v227 = v218
			} else {
				v227 = v225
			}
			if base.Ui32(v227) < base.Ui32(v209) {
				v229 = v209
			} else {
				v229 = v227
			}
			if base.Ui32(v229) < base.Ui32(v191) {
				v231 = v191
			} else {
				v231 = v229
			}
			v234 = v143 - int32(base.Ui32(v73)>>(uint(int32(24))%32))
			v235 = int32(31)
			v236 = v234 >> (uint(v235) % 32)
			v238 = v234 ^ v236 - v236
			v243 = v154 - int32(base.Ui32(v73)>>(uint(int32(16))%32))&int32(255)
			v245 = v243 >> (uint(v235) % 32)
			v247 = v243 ^ v245 - v245
			if base.Ui32(v247) < base.Ui32(v238) {
				v249 = v238
			} else {
				v249 = v247
			}
			v252 = int32(255)
			v254 = v169 - int32(base.Ui32(v73)>>(uint(int32(8))%32))&v252
			v255 = int32(31)
			v256 = v254 >> (uint(v255) % 32)
			v258 = v254 ^ v256 - v256
			v261 = v180 - v73&v252
			v263 = v261 >> (uint(v255) % 32)
			v265 = v261 ^ v263 - v263
			if base.Ui32(v265) < base.Ui32(v258) {
				v267 = v258
			} else {
				v267 = v265
			}
			if base.Ui32(v267) < base.Ui32(v249) {
				v269 = v249
			} else {
				v269 = v267
			}
			v272 = v143 - int32(base.Ui32(v141)>>(uint(int32(24))%32))
			v273 = int32(31)
			v274 = v272 >> (uint(v273) % 32)
			v276 = v272 ^ v274 - v274
			v281 = v154 - int32(base.Ui32(v141)>>(uint(int32(16))%32))&int32(255)
			v283 = v281 >> (uint(v273) % 32)
			v285 = v281 ^ v283 - v283
			if base.Ui32(v285) < base.Ui32(v276) {
				v287 = v276
			} else {
				v287 = v285
			}
			v290 = int32(255)
			v292 = v169 - int32(base.Ui32(v141)>>(uint(int32(8))%32))&v290
			v293 = int32(31)
			v294 = v292 >> (uint(v293) % 32)
			v296 = v292 ^ v294 - v294
			v299 = v180 - v141&v290
			v301 = v299 >> (uint(v293) % 32)
			v303 = v299 ^ v301 - v301
			...
			if base.Ui32(v305) < base.Ui32(v287) {
				v307 = v287
			} else {
				v307 = v305
			}
			if base.Ui32(v307) < base.Ui32(v269) {
				v309 = v269
			} else {
				v309 = v307
			}
			if base.Ui32(v309) < base.Ui32(v231) {
				v311 = v231
			} else {
				v311 = v309
			}
			*(*uint8)(unsafe.Add(mBase, uint32(v75))) = uint8(v311)
			v316 = v76 + int32(-1)
			if v316 != 0 {
				__phi69 = v85
				__phi72 = v141
